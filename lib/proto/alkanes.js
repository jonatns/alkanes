...
var alkanes;
(function (alkanes) {
    var _uint128_one_of_decls, _AlkaneId_one_of_decls, _AlkaneTransfer_one_of_decls, _MessageContextParcel_one_of_decls, _KeyValuePair_one_of_decls, _ExtendedCallResponse_one_of_decls, _Context_one_of_decls, _TraceContext_one_of_decls, _AlkanesEnterContext_one_of_decls, _AlkanesExitContext_one_of_decls, _AlkanesCreate_one_of_decls, _AlkanesTraceEvent_one_of_decls, _AlkanesTrace_one_of_decls, _SimulateResponse_one_of_decls, _AlkaneInventoryRequest_one_of_decls, _AlkaneInventoryResponse_one_of_decls, _DeployedAlkane_one_of_decls, _DeployedAlkanesResponse_one_of_decls;
    ...
    class DeployedAlkane extends pb_1.Message {
        constructor(data) {
            super();
            _DeployedAlkane_one_of_decls.set(this, [[1], [2], [3], [4]]);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _DeployedAlkane_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("id" in data && data.id != undefined) {
                    this.id = data.id;
                }
        ...
        set id(value) {
            pb_1.Message.setOneofWrapperField(this, 1, __classPrivateFieldGet(this, _DeployedAlkane_one_of_decls, "f")[0], value);
        }
        get has_id() {
            return pb_1.Message.getField(this, 1) != null;
        }
        ...
        set name(value) {
            pb_1.Message.setOneofField(this, 2, __classPrivateFieldGet(this, _DeployedAlkane_one_of_decls, "f")[1], value);
        }
        get has_name() {
            return pb_1.Message.getField(this, 2) != null;
        }
        ...
        set symbol(value) {
            pb_1.Message.setOneofField(this, 3, __classPrivateFieldGet(this, _DeployedAlkane_one_of_decls, "f")[2], value);
        }
        get has_symbol() {
            return pb_1.Message.getField(this, 3) != null;
        }
        ...
        set total_supply(value) {
            pb_1.Message.setOneofField(this, 4, __classPrivateFieldGet(this, _DeployedAlkane_one_of_decls, "f")[3], value);
        }
    ...
    _DeployedAlkane_one_of_decls = new WeakMap();
    alkanes.DeployedAlkane = DeployedAlkane;
    class DeployedAlkanesResponse extends pb_1.Message {
        constructor(data) {
            super();
            _DeployedAlkanesResponse_one_of_decls.set(this, [[2]]);
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _DeployedAlkanesResponse_one_of_decls, "f"));
            if (!Array.isArray(data) && typeof data == "object") {
                if ("alkanes" in data && data.alkanes != undefined) {
                    this.alkanes = data.alkanes;
                }
        ...
        get alkanes() {
            return pb_1.Message.getRepeatedWrapperField(this, DeployedAlkane, 1);
        }
        set alkanes(value) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        ...
        set error(value) {
            pb_1.Message.setOneofField(this, 2, __classPrivateFieldGet(this, _DeployedAlkanesResponse_one_of_decls, "f")[0], value);
        }
        get has_error() {
            return pb_1.Message.getField(this, 2) != null;
        }
    ...
    _DeployedAlkanesResponse_one_of_decls = new WeakMap();
    alkanes.DeployedAlkanesResponse = DeployedAlkanesResponse;
